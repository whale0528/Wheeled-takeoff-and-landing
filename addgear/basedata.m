...
lamdaL_flap_TE_tab    = [ 0.000;     0.010;     1.300;     1.300;     1.170;     1.000 ];
lamdaD_flap_TE_tab    = [ 0.000;     0.300;     0.630;     0.850;     0.970;     0.939 ];
...
lamdaL_slat_LE_tab    = [ 1.000;     1.000;     1.000;     1.000;     1.000;     1.000 ];
lamdaD_slat_LE_tab    = [ 1.000;     0.330;     0.630;     0.850;     0.970;     0.939 ];
...
save("aero_tables.mat", ...
    ...
    "delta_flap_TE_tab", "lamdaL_flap_TE_tab", "lamdaD_flap_TE_tab", ...
    "delta_slat_LE_tab", "lamdaL_slat_LE_tab", "lamdaD_slat_LE_tab");
